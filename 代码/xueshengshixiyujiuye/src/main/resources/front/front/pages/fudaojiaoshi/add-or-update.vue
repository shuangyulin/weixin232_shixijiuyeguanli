        ...
        <form class="app-update-pv">
            <view
                ...
                <view :style='{"width":"160rpx","fontSize":"28rpx","color":"#E57498","textAlign":"left"}'
                      class="title">账户</view>
                <input   disabled
                         :style='{"boxShadow":"0 0 0px rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"#E57498","borderRadius":"0px","color":"#E57498","textAlign":"left","borderWidth":"0 0 6rpx","fontSize":"24rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
            ...
            <view
                ...
                <input   disabled
                         :style='{"boxShadow":"0 0 0px rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"#E57498","borderRadius":"0px","color":"#E57498","textAlign":"left","borderWidth":"0 0 6rpx","fontSize":"24rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                         :disabled="ro.fudaojiaoshiName" type="text" v-model="ruleForm.fudaojiaoshiName" placeholder="教师姓名"></input>
            </view>
                <view
                        ...
                        class="cu-form-group" @tap="fudaojiaoshiPhotoTap">
                    <view :style='{"width":"160rpx","fontSize":"28rpx","color":"#E57498","textAlign":"left"}'
                          class="title">头像</view>
                    <view class="right-input" style="padding:0;textAlign:left">
                        <image
                                ...
                                class="avator" v-if="ruleForm.fudaojiaoshiPhoto" :src="ruleForm.fudaojiaoshiPhoto" mode="aspectFill">
                        </image>
                    ...
                    class="cu-form-group">
                <view :style='{"width":"160rpx","fontSize":"28rpx","color":"#E57498","textAlign":"left"}'
                      class="title">教师手机号</view>
                <input   disabled
                         :style='{"boxShadow":"0 0 0px rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"#E57498","borderRadius":"0px","color":"#E57498","textAlign":"left","borderWidth":"0 0 6rpx","fontSize":"24rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                         :disabled="ro.fudaojiaoshiPhone" type="text" v-model="ruleForm.fudaojiaoshiPhone" placeholder="教师手机号"></input>
            </view>
            <view
                    :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"88rpx"}'
                    class="cu-form-group">
                ...
                <input   disabled
                         :style='{"boxShadow":"0 0 0px rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 1)","borderColor":"#E57498","borderRadius":"0px","color":"#E57498","textAlign":"left","borderWidth":"0 0 6rpx","fontSize":"24rpx","borderStyle":"solid","height":"88rpx","marginTop":"7rpx"}'
                         :disabled="ro.fudaojiaoshiEmail" type="text" v-model="ruleForm.fudaojiaoshiEmail" placeholder="邮箱"></input>
            </view>
    ...
    export default {
		...
		/*下拉框*/
            ...
            if (options.id) {
                ...
                // 获取信息
                let res = await this.$api.info(`fudaojiaoshi`, this.ruleForm.id);
                this.ruleForm = res.data;
            }
            if(options.fudaojiaoshiId){
                this.ruleForm.fudaojiaoshiId = options.fudaojiaoshiId;
            }
            // 跨表
            // this.styleChange()
        },
        methods: {
			...
			fudaojiaoshiPhotoTap() {
                let _this = this;
                this.$api.upload(function(res) {
                    _this.ruleForm.fudaojiaoshiPhoto = _this.$base.url + 'upload/' + res.file;
                    _this.$forceUpdate();
                    _this.$nextTick(() => {
                        // _this.styleChange()
                    })
            ...
            async onSubmitTap() {
				...
				if ((!this.ruleForm.fudaojiaoshiName)) {
                    this.$utils.msg(`教师姓名不能为空`);
                    return
                }
				if ((!this.ruleForm.fudaojiaoshiPhoto)) {
                    this.$utils.msg(`头像不能为空`);
                    return
                }
				if ((!this.ruleForm.fudaojiaoshiPhone) && (!this.$validate.isMobile(this.ruleForm.fudaojiaoshiPhone))) {
                    this.$utils.msg(`教师手机号不能为空并且需要输入正确格式`);
                    return
                }
				if ((!this.ruleForm.fudaojiaoshiEmail) && (!this.$validate.isEmail(this.ruleForm.fudaojiaoshiEmail))) {
                ...
                if (this.ruleForm.id) {
                    await this.$api.update(`fudaojiaoshi`, this.ruleForm);
                } else {
                    await this.$api.save(`fudaojiaoshi`, this.ruleForm);
                }
